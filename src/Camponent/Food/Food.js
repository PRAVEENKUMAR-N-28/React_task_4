        ...
        <section>
            <div className="Dis_food">
                ...
                <div className="Dis_food_list">
                    ...
                    <div className="Dis_list_2">
                        <div className="Dis_3">
                            <p className='Dis_name'>Food of Kodaikanal</p>
                            <p>
                        ...
                        <div className="Dis_4">
                            <p className='Dis_name'>Food of Ooty</p>
                            <p>
                    ...
                    <div className="Dis_list_2">
                        <div className="Dis_5">
                            <p className='Dis_name'>Food of Kanyakumari</p>
                            <p>
                        ...
                        <div className="Dis_6">
                            <p className='Dis_name'>Food of Kumbakonam</p>
                            <p>
                    ...
                    <div className="Dis_list_2">
                        <div className="Dis_7">
                            <p className='Dis_name'>Food of Madurai</p>
                            <p>
                        ...
                        <div className="Dis_8">
                            <p className='Dis_name'>Food of Yercaud</p>
                            <p>
                    ...
                    <div className="Dis_list_2">
                        <div className="Dis_9">
                            <p className='Dis_name'>Food of Hogenakkal</p>
                            <p>
                        ...
                        <div className="Dis_10">
                            <p className='Dis_name'>Food of Theni</p>
                            <p>
